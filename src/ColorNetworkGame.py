...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Wall({"hitPoints": 4}), 37, 1, 30)
    ...
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 1}), 10, 2, 10)
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100}), "dischargeRate": 1}), 29, 2, 33)
    self.addBundle([Battery({"maxCharge": b.d(1), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10)})], 4, 2, 10)
    self.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5)})], 30, 2, 38)
    self.add(Wall({"hitPoints": 8}), 22, 2, 50)
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 10, 2, 10)
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 25, 2, 18)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 10, 2, 10)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 21, 2, 21)
    self.add(Divider({"divisor": 2}), 10, 2, 10)
    self.add(Divider({"divisor": 5}), 19, 2, 10)
    self.add(Capacitor({"maxEnergy": y.d(10), "signalOutputFraction": 0.1}), 17, 2, 16)
    self.add(Capacitor({"maxEnergy": y.d(100), "signalOutputFraction": 0.1}), 10, 2, 10)
    # self.add(type(properties), popularity, complexity=3, cost)
    self.add(HealthSensor({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "outputRatio": 0.1}), 10, 4, 10)
    self.add(InputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 13, 3, 12)
    self.add(OutputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 10, 3, 10)
    ...
    self.add(PowerInputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 5, 3, 10)
    ...
    self.add(Shield({"defenseFraction": 1.0, "radius": 0, "requiredPower": y.d(6), "maxSignalPower": y.d(1), "maxPossibleDistance": 1}), 10, 3, 10)
    self.add(Shield({"defenseFraction": 0.5, "radius": 1, "requiredPower": y.d(4), "maxSignalPower": y.d(10), "maxPossibleDistance": 100}), 10, 3, 10)
    # self.add(type(properties), popularity, complexity=4, cost)
    self.add(PowerUsageSensor({"radius": 1, "requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "outputRatio": 0.1}), 10, 4, 10)
