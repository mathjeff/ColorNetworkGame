...
class DefaultItemDataFactory(ItemDataFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(InputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 27, 1, 17)
    self.add(OutputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 1, 11)
