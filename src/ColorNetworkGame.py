...
class OfferingBuilder(object):
  def __init__(self, complexity, factory):
    self.complexity = complexity
    self.factory = factory

  def add(self, item, popularity, cost):
    self.factory.add(item, popularity, self.complexity, cost)

  def addBundle(self, bundle, popularity, cost):
    self.factory.addBundle(bundle, popularity, self.complexity, cost)
...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    builder = OfferingBuilder(1, self)
    builder.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 10, 27)
    builder.add(Battery({"maxCharge": y.d(100), "dischargeRate": 3}), 20, 15)
    builder.add(Wall({"hitPoints": 4, "outputPerDamage": e.d(1)}), 20, 22)
    # self.add(type(properties), popularity, cost)
    builder = OfferingBuilder(2, self)
    builder.add(Laser({"requiredPower": y.d(4), "damage": 4, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 21, 27)
    builder.add(Laser({"requiredPower": y.d(2), "damage": 2, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 11, 38)
    builder.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(3), "maxPossibleTarget": 3}), 17, 39)
    ...
    builder.add(Battery({"maxCharge": y.d(10), "dischargeRate": 4}), 20, 9)
    builder.add(Battery({"maxCharge": y.d(20), "dischargeRate": 2}), 17, 9)
    builder.add(Battery({"maxCharge": y.d(100), "dischargeRate": 1}), 7, 12)
    builder.add(Battery({"maxCharge": m.d({yellow:100, black:100, green:100, grey:100}), "dischargeRate": 1}), 22, 29)
    builder.addBundle([Battery({"maxCharge": b.d(2), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10), "numUsesPerTurn": 1})], 4, 10)
    builder.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5), "numUsesPerTurn": 1})], 29, 23)
    builder.add(Battery({"maxCharge": g.d(1000), "dischargeRate": 1}), 24, 16)
    builder.addBundle([Converter({"requiredPower": b.d(0.3), "outputPower": g.d(1), "numUsesPerTurn": 1}), Converter({"requiredPower": y.d(1.9), "outputPower": g.d(1), "numUsesPerTurn": 1}), Converter({"requiredPower": e.d(1), "outputPower": g.d(1), "numUsesPerTurn": "1"})], 7, 21)
    builder.add(Converter({"requiredPower": b.d(0.5), "outputPower": g.d(2), "numUsesPerTurn": 1}), 12, 7)
    builder.add(Converter({"requiredPower": y.d(0.4), "outputPower": g.d(0.5), "numUsesPerTurn": 2}), 25, 14)
    builder.add(Converter({"requiredPower": e.d(1), "outputPower": g.d(2), "numUsesPerTurn": 1}), 25, 14)
    builder.add(Converter({"requiredPower": g.d(1), "outputPower": m.d({yellow:1, black:1, grey: 1}), "numUsesPerTurn": 1}), 7, 18)
    builder.add(Converter({"requiredPower": g.d(1), "outputPower": y.d(4), "numUsesPerTurn": 3}), 5, 12)
    builder.add(Converter({"requiredPower": g.d(1), "outputPower": b.d(2), "numUsesPerTurn": 1}), 6, 11)
    builder.add(Converter({"requiredPower": g.d(1), "outputPower": e.d(1), "numUsesPerTurn": 1}), 6, 11)
    builder.add(Wall({"hitPoints": 8, "outputPerDamage": e.d(1)}), 14, 35)
    builder.add(UnstableWall({"hitPoints": 12, "outputPerDamage": e.d(1), "decayPerTurn": 1}), 14, 35)
    builder.add(CellWall({"hitPoints": 8, "requiredPower": g.d(1), "hitpointGainPerUse": 1, "numUsesPerTurn": 2}), 12, 32)
    builder.add(Adder({"addition": 0.2, "maxInput": 10}), 19, 12)
    builder.add(Adder({"addition": 0.4, "maxInput": 10}), 15, 16)
    builder.add(Counter({"step": 0.1}), 20, 20)
    builder.add(Comparer({"threshold": 0.2}), 6, 10)
    builder.add(Comparer({"threshold": 0.3}), 6, 10)
    ...
    # self.add(type(properties), popularity, cost)
    builder = OfferingBuilder(3, self)
    builder.add(Cutter({"requiredPower": y.d(1), "maxNumCutsPerTurn": 4, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 20)
    builder.add(Cutter({"requiredPower": y.d(2), "maxNumCutsPerTurn": 8, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 20)
    builder.add(Adder({"addition": 0.1, "maxInput": 10}), 7, 15)
    builder.add(Adder({"addition": 0.3, "maxInput": 10}), 8, 11)
    builder.add(Comparer({"threshold": 0.5}), 6, 10)
    builder.add(Comparer({"threshold": 0.7}), 6, 10)
    builder.add(Joiner({"numInputs": 3}), 11, 17)
    builder.add(PowerInputDrainer({"powerPerDrain": y.d(1), "maxPower": y.d(15), "maxPositionPower": y.d(10), "maxPossibleTarget": 100, "maxRadiusPower": y.d(1), "maxRadius": 5}), 10, 17)
    builder.add(PowerOutputDrainer({"powerPerDrain": y.d(1), "maxPower": y.d(15), "maxPositionPower": y.d(10), "maxPossibleTarget": 100, "maxRadiusPower": y.d(1), "maxRadius": 5}), 8, 9)
    builder.add(Shield({"defenseFraction": 1.0, "radius": 0, "requiredPower": y.d(6), "maxSignalPower": y.d(1), "maxPossibleDistance": 1}), 11, 44)
