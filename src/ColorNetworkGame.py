...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 3}), 20, 1, 15)
    self.add(Wall({"hitPoints": 4, "outputPerDamage": e.d(1)}), 20, 1, 22)
    ...
    self.add(Laser({"requiredPower": b.d(1), "damage": 8, "maxSignalPower": b.d(1), "maxPossibleTarget": 0}), 20, 2, 29)
    self.add(Flipper({"maxPower": y.d(20), "strengthPerPower":3, "hitpoints":4}), 5, 2, 24)
    self.add(Infector({"requiredPower": g.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 2, 20)
