...
class DefaultItemDataFactory(ItemDataFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(InputCutter({"requiredPower": 1, "maxSignalPower": 1, "maxPossibleTarget": 100}), 2, 1, 10)
    self.add(OutputCutter({"requiredPower": 1, "maxSignalPower": 1, "maxPossibleTarget": 100}), 2, 1, 10)
    ...
    self.add(PowerInputDrainer({"requiredPower": 1, "maxSignalPower": 1, "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 2, 2, 10)
    self.add(PowerOutputDrainer({"requiredPower": 1, "maxSignalPower": 1, "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 2, 2, 10)
    ...
    self.add(If({"threshold": 0.07}), 1, 2, 10)
    self.add(Capacitor({"maxEnergy": 10, "signalOutputFraction": 0.01}), 2, 2, 10)
    ...
    self.add(Shield({"defenseFraction": 0.5, "radius": 1, "requiredPower": 4, "maxSignalPower": 1, "maxPossibleDistance": 100}), 2, 3, 20)
