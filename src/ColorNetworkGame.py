...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 25, 1, 44)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 3}), 18, 1, 26)
    self.add(Wall({"hitPoints": 4}), 35, 1, 26)
    # self.add(type(properties), popularity, complexity=2, cost)
    self.add(Laser({"requiredPower": y.d(4), "damage": 4, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 19, 2, 19)
    self.add(Laser({"requiredPower": y.d(2), "damage": 2, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 21, 2, 27)
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(3), "maxPossibleTarget": 3}), 12, 2, 10)
    self.add(Laser({"requiredPower": y.d(1), "damage": 0.5, "maxSignalPower": y.d(10), "maxPossibleTarget": 3}), 10, 2, 10)
    self.add(Laser({"requiredPower": b.d(1), "damage": 8, "maxSignalPower": y.d(1), "maxPossibleTarget": 0}), 19, 2, 19)
    self.add(Flipper({"maxPower": y.d(10), "strengthPerPower":2, "hitpoints":4}), 10, 2, 10)
    self.addBundle([Battery({"maxCharge": b.d(3), "dischargeRate": 3}), Ram({"maxPower": b.d(10), "damagePerPower":4})], 9, 2, 7)
    self.add(Battery({"maxCharge": y.d(10), "dischargeRate": 4}), 16, 2, 10)
    self.add(Battery({"maxCharge": y.d(20), "dischargeRate": 2}), 24, 2, 19)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 1}), 12, 2, 10)
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100}), "dischargeRate": 1}), 16, 2, 10)
    self.addBundle([Battery({"maxCharge": b.d(1), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10)})], 5, 2, 10)
    self.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5)})], 27, 2, 18)
    self.add(Wall({"hitPoints": 8}), 38, 2, 42)
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 5, 2, 10)
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 17, 2, 10)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 3, 2, 10)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 5, 2, 10)
    self.add(Divider({"divisor": 2}), 7, 2, 10)
    self.add(Divider({"divisor": 5}), 6, 2, 10)
    self.add(Capacitor({"maxEnergy": y.d(10), "signalOutputFraction": 0.1}), 16, 2, 17)
    self.add(Capacitor({"maxEnergy": y.d(100), "signalOutputFraction": 0.1}), 19, 2, 25)
    # self.add(type(properties), popularity, complexity=3, cost)
    self.add(HealthSensor({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "outputRatio": 0.1}), 9, 4, 10)
    self.add(InputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 3, 14)
    self.add(OutputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 17, 3, 10)
    self.add(IfLess({"threshold": 0.2}), 3, 3, 10)
    self.add(IfMore({"threshold": 0.3}), 5, 3, 10)
    self.add(IfMore({"threshold": 0.5}), 5, 3, 10)
    self.add(IfMore({"threshold": 0.7}), 3, 3, 10)
    self.add(Joiner({}), 11, 3, 10)
    self.add(PowerInputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 12, 3, 10)
    self.add(PowerOutputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 13, 3, 10)
    self.add(Shield({"defenseFraction": 1.0, "radius": 0, "requiredPower": y.d(6), "maxSignalPower": y.d(1), "maxPossibleDistance": 1}), 8, 3, 10)
    self.add(Shield({"defenseFraction": 0.5, "radius": 1, "requiredPower": y.d(4), "maxSignalPower": y.d(10), "maxPossibleDistance": 100}), 8, 3, 10)
    # self.add(type(properties), popularity, complexity=4, cost)
    self.add(PowerUsageSensor({"radius": 1, "requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "outputRatio": 0.1}), 3, 4, 10)
