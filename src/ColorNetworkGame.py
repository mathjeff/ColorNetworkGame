...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Laser({"requiredPower": b.d(1), "damage": 8, "maxSignalPower": b.d(1), "maxPossibleTarget": 0}), 23, 2, 65)
    self.add(Flipper({"maxPower": y.d(15), "strengthPerPower":3, "hitpoints":4}), 3, 2, 14)
    self.add(Infector({"requiredPower": g.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 30, 2, 30)
    ...
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100, green:100}), "dischargeRate": 1}), 28, 2, 30)
    ...
    self.add(Battery({"maxCharge": g.d(1000), "dischargeRate": 1}), 30, 2, 20)
    self.addBundle([Converter({"requiredPower": b.d(1), "outputPower": g.d(4)}), Converter({"requiredPower": y.d(2), "outputPower": g.d(1)})], 20, 2, 20)
    self.add(Converter({"requiredPower": b.d(1), "outputPower": g.d(6)}), 30, 2, 20)
    self.add(Converter({"requiredPower": y.d(1), "outputPower": g.d(1)}), 30, 2, 10)
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2)}), Converter({"requiredPower": g.d(3), "outputPower": b.d(1)})], 20, 2, 20)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": y.d(3)}), 15, 2, 10)
    self.add(Converter({"requiredPower": g.d(2), "outputPower": b.d(1)}), 15, 2, 10)
    self.add(Wall({"hitPoints": 8}), 21, 2, 40)
    self.add(CellWall({"hitPoints": 8, "requiredPower": g.d(1), "hitpointGainPerTurn": 1}), 20, 2, 40)
