...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.addBundle([Converter({"requiredPower": b.d(1), "outputPower": g.d(4)}), Converter({"requiredPower": y.d(2), "outputPower": g.d(1)})], 21, 2, 21)
    self.add(Converter({"requiredPower": b.d(1), "outputPower": g.d(6)}), 27, 2, 15)
    self.add(Converter({"requiredPower": y.d(1), "outputPower": g.d(1)}), 28, 2, 8)
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2)}), Converter({"requiredPower": g.d(3), "outputPower": b.d(1)})], 18, 2, 8)
