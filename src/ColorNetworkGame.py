...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.addBundle([Converter({"requiredPower": b.d(0.3), "outputPower": g.d(1)}), Converter({"requiredPower": y.d(2), "outputPower": g.d(1)})], 20, 2, 16)
    self.add(Converter({"requiredPower": b.d(0.2), "outputPower": g.d(1)}), 25, 2, 10)
    self.add(Converter({"requiredPower": y.d(1), "outputPower": g.d(1)}), 30, 2, 6)
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2)}), Converter({"requiredPower": g.d(1), "outputPower": b.d(0.3)})], 19, 2, 12)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": y.d(3)}), 10, 2, 7)
    self.add(Converter({"requiredPower": g.d(2), "outputPower": b.d(1)}), 14, 2, 11)
