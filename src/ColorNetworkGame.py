...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Wall({"hitPoints": 4}), 37, 1, 23)
    ...
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100, green:100}), "dischargeRate": 1}), 22, 2, 29)
    self.addBundle([Battery({"maxCharge": b.d(2), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10), "numUsesPerTurn": 1})], 3, 2, 17)
    ...
    self.add(Converter({"requiredPower": g.d(1), "outputPower": b.d(2), "numUsesPerTurn": 2}), 6, 2, 11)
    self.add(Wall({"hitPoints": 8}), 15, 2, 36)
    ...
    self.add(Capacitor({"maxEnergy": m.d({yellow:10, black:10, green:10}), "signalOutputFraction": 0.1}), 11, 2, 14)
    ...
    self.add(Joiner({"numInputs": 2}), 13, 3, 21)
