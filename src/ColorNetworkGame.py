...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Battery({"maxCharge": y.d(10), "dischargeRate": 4}), 16, 2, 9)
    self.add(Battery({"maxCharge": y.d(20), "dischargeRate": 2}), 24, 2, 19)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 1}), 12, 2, 4)
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100}), "dischargeRate": 1}), 16, 2, 6)
    self.addBundle([Battery({"maxCharge": b.d(1), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10)})], 5, 2, 5)
    ...
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 5, 2, 4)
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 17, 2, 9)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 3, 2, 3)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 5, 2, 4)
    self.add(Divider({"divisor": 2}), 7, 2, 1)
    self.add(Divider({"divisor": 5}), 6, 2, 2)
    ...
    self.add(HealthSensor({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "outputRatio": 0.1}), 9, 4, 9)
    ...
    self.add(If({"threshold": 0.3}), 5, 3, 4)
    self.add(If({"threshold": 0.5}), 5, 3, 4)
    self.add(If({"threshold": 0.7}), 3, 3, 3)
    self.add(Joiner({}), 11, 3, 6)
    self.add(PowerInputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 12, 3, 4)
    self.add(PowerOutputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 13, 3, 7)
    self.add(Shield({"defenseFraction": 1.0, "radius": 0, "requiredPower": y.d(6), "maxSignalPower": y.d(1), "maxPossibleDistance": 1}), 8, 3, 8)
    self.add(Shield({"defenseFraction": 0.5, "radius": 1, "requiredPower": y.d(4), "maxSignalPower": y.d(10), "maxPossibleDistance": 100}), 8, 3, 8)
    # self.add(type(properties), popularity, complexity=4, cost)
    self.add(PowerUsageSensor({"radius": 1, "requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "outputRatio": 0.1}), 3, 4, 3)
