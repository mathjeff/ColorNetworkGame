...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Wall({"hitPoints": 4}), 27, 1, 15)
    # self.add(type(properties), popularity, complexity=2, cost)
    self.add(InputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 27, 2, 17)
    self.add(OutputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 2, 11)
    self.add(Laser({"requiredPower": y.d(4), "damage": 4, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 15, 2, 15)
    self.add(Laser({"requiredPower": y.d(2), "damage": 2, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 20, 2, 23)
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(3), "maxPossibleTarget": 3}), 15, 2, 15)
    self.add(PowerInputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 15, 2, 7)
    self.add(PowerOutputDrainer({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100, "radius": 1, "drainPerItem": 1}), 15, 2, 7)
    self.addBundle([Battery({"maxCharge": b.d(3), "dischargeRate": 3}), Ram({"maxPower": b.d(10), "damagePerPower":4})], 10, 2, 10)
    ...
    self.addBundle([Battery({"maxCharge": b.d(1), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10)})], 10, 2, 10)
    self.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5)})], 10, 2, 10)
    self.add(Wall({"hitPoints": 8}), 38, 2, 35)
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 7, 2, 7)
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 7, 2, 7)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 7, 2, 7)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 7, 2, 7)
    self.add(Divider({"divisor": 2}), 7, 2, 3)
    self.add(Divider({"divisor": 5}), 12, 2, 5)
    self.add(Fork({"maxInput": 10}), 7, 2, 7)
    self.add(Joiner({}), 7, 2, 7)
    self.add(If({"threshold": 0.3}), 7, 2, 7)
