...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 19, 2, 13)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 16, 2, 16)
    self.add(Comparer({"threshold": 0.2}), 5, 2, 18)
    self.add(Comparer({"threshold": 0.3}), 5, 2, 17)
    ...
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 8, 3, 15)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 8, 3, 12)
