...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.addBundle([Converter({"requiredPower": b.d(0.3), "outputPower": g.d(1), "numUsesPerTurn": 1}), Converter({"requiredPower": y.d(2), "outputPower": g.d(1), "numUsesPerTurn": 1})], 13, 2, 14)
    ...
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2), "numUsesPerTurn": 1}), Converter({"requiredPower": g.d(2), "outputPower": b.d(1), "numUsesPerTurn": 1})], 8, 2, 12)
