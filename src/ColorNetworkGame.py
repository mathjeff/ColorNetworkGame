...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 12, 1, 34)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 3}), 27, 1, 12)
    self.add(Wall({"hitPoints": 4}), 44, 1, 46)
    # self.add(type(properties), popularity, complexity=2, cost)
    self.add(Laser({"requiredPower": y.d(4), "damage": 4, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 24, 2, 38)
    self.add(Laser({"requiredPower": y.d(2), "damage": 2, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 16, 2, 29)
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(3), "maxPossibleTarget": 3}), 22, 2, 14)
    self.add(Laser({"requiredPower": y.d(1), "damage": 0.5, "maxSignalPower": y.d(10), "maxPossibleTarget": 3}), 14, 2, 13)
    self.add(Laser({"requiredPower": b.d(1), "damage": 8, "maxSignalPower": b.d(1), "maxPossibleTarget": 0}), 21, 2, 45)
    self.add(Flipper({"maxPower": y.d(15), "strengthPerPower":3, "hitpoints":4}), 3, 2, 14)
    self.add(Infector({"requiredPower": g.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 32, 2, 47)
    self.addBundle([Battery({"maxCharge": b.d(3), "dischargeRate": 3}), Ram({"maxPower": b.d(10), "damagePerPower":4})], 22, 2, 22)
    self.add(Battery({"maxCharge": y.d(10), "dischargeRate": 4}), 21, 2, 8)
    self.add(Battery({"maxCharge": y.d(20), "dischargeRate": 2}), 17, 2, 13)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 1}), 8, 2, 4)
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100, green:100}), "dischargeRate": 1}), 28, 2, 28)
    self.addBundle([Battery({"maxCharge": b.d(1), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10)})], 3, 2, 12)
    self.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5)})], 29, 2, 24)
    self.add(Battery({"maxCharge": g.d(1000), "dischargeRate": 1}), 27, 2, 13)
    self.addBundle([Converter({"requiredPower": b.d(0.3), "outputPower": g.d(1)}), Converter({"requiredPower": y.d(2), "outputPower": g.d(1)})], 21, 2, 21)
    self.add(Converter({"requiredPower": b.d(0.2), "outputPower": g.d(1)}), 27, 2, 15)
    self.add(Converter({"requiredPower": y.d(1), "outputPower": g.d(1)}), 28, 2, 8)
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2)}), Converter({"requiredPower": g.d(1), "outputPower": b.d(0.3)})], 18, 2, 8)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": y.d(3)}), 13, 2, 16)
    self.add(Converter({"requiredPower": g.d(2), "outputPower": b.d(1)}), 15, 2, 10)
    self.add(Wall({"hitPoints": 8}), 21, 2, 40)
    self.add(CellWall({"hitPoints": 8, "requiredPower": g.d(1), "hitpointGainPerTurn": 1}), 20, 2, 53)
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 9, 2, 14)
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 24, 2, 20)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 10, 2, 18)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 17, 2, 10)
    self.add(Divider({"divisor": 2}), 9, 2, 4)
    self.add(Divider({"divisor": 5}), 22, 2, 6)
    self.add(Capacitor({"maxEnergy": y.d(10), "signalOutputFraction": 0.1}), 15, 2, 15)
    self.add(Capacitor({"maxEnergy": y.d(100), "signalOutputFraction": 0.1}), 10, 2, 7)
    self.add(Capacitor({"maxEnergy": m.d({yellow:10, black:10, green:10}), "signalOutputFraction": 0.1}), 15, 2, 26)
    ...
    self.add(Comparer({"threshold": 0.2}), 5, 3, 10)
    self.add(Comparer({"threshold": 0.3}), 5, 3, 17)
    self.add(Comparer({"threshold": 0.5}), 5, 3, 10)
    self.add(Comparer({"threshold": 0.7}), 5, 3, 10)
    self.add(Joiner({"numInputs": 2}), 7, 3, 7)
    self.add(Joiner({"numInputs": 3}), 10, 3, 10)
    self.add(PowerInputDrainer({"powerPerDrain": y.d(1), "maxPower": y.d(15), "maxPositionPower": y.d(10), "maxPossibleTarget": 100, "maxRadiusPower": y.d(1), "maxRadius": 5}), 10, 3, 10)
    self.add(PowerOutputDrainer({"powerPerDrain": y.d(1), "maxPower": y.d(15), "maxPositionPower": y.d(10), "maxPossibleTarget": 100, "maxRadiusPower": y.d(1), "maxRadius": 5}), 10, 3, 10)
    self.add(Shield({"defenseFraction": 1.0, "radius": 0, "requiredPower": y.d(6), "maxSignalPower": y.d(1), "maxPossibleDistance": 1}), 10, 3, 23)
