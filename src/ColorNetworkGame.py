...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 11, 1, 27)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 3}), 39, 1, 17)
    self.add(Wall({"hitPoints": 4}), 40, 1, 24)
    # self.add(type(properties), popularity, complexity=2, cost)
    self.add(Laser({"requiredPower": y.d(4), "damage": 4, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 23, 2, 26)
    self.add(Laser({"requiredPower": y.d(2), "damage": 2, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 12, 2, 38)
    self.add(Laser({"requiredPower": y.d(1), "damage": 1, "maxSignalPower": y.d(3), "maxPossibleTarget": 3}), 23, 2, 48)
    self.add(Laser({"requiredPower": y.d(1), "damage": 0.5, "maxSignalPower": y.d(6), "maxPossibleTarget": 3}), 9, 2, 6)
    self.add(Laser({"requiredPower": b.d(1), "damage": 8, "maxSignalPower": b.d(1), "maxPossibleTarget": 0}), 21, 2, 20)
    self.add(Flipper({"maxPower": y.d(20), "strengthPerPower":3, "hitpoints":4}), 5, 2, 23)
    self.add(Infector({"requiredPower": g.d(1), "damage": 1, "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 27, 2, 13)
    self.addBundle([Battery({"maxCharge": b.d(3), "dischargeRate": 3}), Ram({"maxPower": b.d(10), "damagePerPower":4})], 26, 2, 26)
    self.add(Battery({"maxCharge": y.d(10), "dischargeRate": 4}), 23, 2, 10)
    self.add(Battery({"maxCharge": y.d(20), "dischargeRate": 2}), 17, 2, 9)
    self.add(Battery({"maxCharge": y.d(100), "dischargeRate": 1}), 7, 2, 11)
    self.add(Battery({"maxCharge": m.d({yellow:100, black:100, green:100}), "dischargeRate": 1}), 25, 2, 32)
    self.addBundle([Battery({"maxCharge": b.d(2), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10), "numUsesPerTurn": 1})], 4, 2, 18)
    self.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5), "numUsesPerTurn": 1})], 32, 2, 24)
    self.add(Battery({"maxCharge": g.d(1000), "dischargeRate": 1}), 23, 2, 15)
    self.addBundle([Converter({"requiredPower": b.d(0.3), "outputPower": g.d(1), "numUsesPerTurn": 1}), Converter({"requiredPower": y.d(1.9), "outputPower": g.d(1), "numUsesPerTurn": 1})], 7, 2, 14)
    self.add(Converter({"requiredPower": b.d(0.2), "outputPower": g.d(1), "numUsesPerTurn": 1}), 11, 2, 5)
    self.add(Converter({"requiredPower": y.d(0.4), "outputPower": g.d(0.5), "numUsesPerTurn": 2}), 19, 2, 9)
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2), "numUsesPerTurn": 1}), Converter({"requiredPower": g.d(1), "outputPower": b.d(1), "numUsesPerTurn": 1})], 7, 2, 12)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": y.d(4), "numUsesPerTurn": 3}), 6, 2, 14)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": b.d(2), "numUsesPerTurn": 2}), 5, 2, 9)
    self.add(Wall({"hitPoints": 8}), 19, 2, 42)
    self.add(CellWall({"hitPoints": 8, "requiredPower": g.d(1), "hitpointGainPerUse": 1, "numUsesPerTurn": 2}), 11, 2, 27)
    self.add(Adder({"addition": 0.1, "maxInput": 10}), 8, 2, 14)
    self.add(Adder({"addition": 0.2, "maxInput": 10}), 18, 2, 12)
    self.add(Adder({"addition": 0.3, "maxInput": 10}), 7, 2, 10)
    self.add(Adder({"addition": 0.4, "maxInput": 10}), 14, 2, 12)
    self.add(Divider({"divisors": [2, 5]}), 10, 2, 7)
    self.add(Capacitor({"maxEnergy": y.d(10), "signalOutputFraction": 0.1}), 16, 2, 26)
    self.add(Capacitor({"maxEnergy": y.d(100), "signalOutputFraction": 0.1}), 10, 2, 17)
    self.add(Capacitor({"maxEnergy": m.d({yellow:10, black:10, green:10}), "signalOutputFraction": 0.1}), 12, 2, 19)
    self.add(Capacitor({"maxEnergy": g.d(20), "startingEnergy": g.d(10), "signalOutputFraction": 0.1}), 8, 2, 8)
    # self.add(type(properties), popularity, complexity=3, cost)
    self.add(InputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 11, 3, 11)
    self.add(OutputCutter({"requiredPower": y.d(1), "maxSignalPower": y.d(10), "maxPossibleTarget": 100}), 7, 3, 7)
    self.add(Comparer({"threshold": 0.2}), 5, 3, 18)
    self.add(Comparer({"threshold": 0.3}), 5, 3, 17)
    self.add(Comparer({"threshold": 0.5}), 5, 3, 12)
    ...
    self.add(PowerOutputDrainer({"powerPerDrain": y.d(1), "maxPower": y.d(15), "maxPositionPower": y.d(10), "maxPossibleTarget": 100, "maxRadiusPower": y.d(1), "maxRadius": 5}), 9, 3, 9)
    self.add(Shield({"defenseFraction": 1.0, "radius": 0, "requiredPower": y.d(6), "maxSignalPower": y.d(1), "maxPossibleDistance": 1}), 11, 3, 47)
