...
class DefaultOfferingFactory(OfferingFactory):
  ...
  def loadDefaults(self):
    ...
    self.add(Flipper({"maxPower": y.d(20), "strengthPerPower":3, "hitpoints":4}), 5, 2, 17)
    ...
    self.addBundle([Battery({"maxCharge": b.d(2), "dischargeRate": 1}), Converter({"requiredPower": b.d(1), "outputPower": y.d(10), "numUsesPerTurn": 1})], 4, 2, 17)
    self.addBundle([Battery({"maxCharge": b.d(5), "dischargeRate": 5}), Converter({"requiredPower": b.d(1), "outputPower": y.d(5), "numUsesPerTurn": 1})], 31, 2, 29)
    self.add(Battery({"maxCharge": g.d(1000), "dischargeRate": 1}), 28, 2, 20)
    self.addBundle([Converter({"requiredPower": b.d(0.3), "outputPower": g.d(1), "numUsesPerTurn": 1}), Converter({"requiredPower": y.d(2), "outputPower": g.d(1), "numUsesPerTurn": 1})], 15, 2, 16)
    self.add(Converter({"requiredPower": b.d(0.2), "outputPower": g.d(1), "numUsesPerTurn": 1}), 15, 2, 10)
    self.add(Converter({"requiredPower": y.d(0.4), "outputPower": g.d(0.5), "numUsesPerTurn": 2}), 20, 2, 6)
    self.addBundle([Converter({"requiredPower": g.d(1), "outputPower": y.d(2), "numUsesPerTurn": 1}), Converter({"requiredPower": g.d(2), "outputPower": b.d(1), "numUsesPerTurn": 1})], 10, 2, 12)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": y.d(4), "numUsesPerTurn": 3}), 5, 2, 7)
    self.add(Converter({"requiredPower": g.d(1), "outputPower": b.d(2), "numUsesPerTurn": 3}), 6, 2, 11)
